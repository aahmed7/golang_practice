// Taken from https://github.com/fakhir/learngo/blob/master/refresher.go
...
// Incrementer Implement Incrementer and Decrementer interfaces
type Incrementer interface {
	Increment() int
}

// Decrementer Implement Incrementer and Decrementer interfaces
type Decrementer interface {
	Decrement() int
}

// IncrementerDecrementer  Directly embedding one interface into another causes all the child's methods to
...
// Increment Implement Incrementer and Decrementer interfaces for *Counter
func (ctr *Counter) Increment() int {
	*ctr++
	return int(*ctr)
}

// Decrement Implement Incrementer and Decrementer interfaces for *Counter
